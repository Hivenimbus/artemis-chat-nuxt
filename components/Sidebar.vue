<template>
  ...
  >
    ...
    >
      ...
      <!-- Botão Superadmin destacado -->
      <NuxtLink
        to="/painel-superadmin"
      ...
      >
        ...
        <!-- Ícone de coroa/escudo -->
        <svg
          class="h-5 w-5 flex-shrink-0 relative z-10"
          :class="[
            isActive('/painel-superadmin') ? 'text-white' : 'text-white/90 group-hover:text-white'
          ]"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        ...
        <span
          class="ml-3 transition-opacity duration-300 delay-100 relative z-10"
          :class="[
            isExpanded ? 'opacity-100' : 'opacity-0 absolute invisible'
          ]"
        >
        ...
        <!-- Ícone de seta quando expandido -->
        <svg
          v-if="isExpanded"
          class="h-4 w-4 ml-auto transition-transform duration-200 relative z-10"
          :class="[
            isActive('/painel-superadmin') ? 'text-white' : 'text-white/70 group-hover:text-white',
            isActive('/painel-superadmin') ? 'transform rotate-0' : ''
          ]"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
    ...
    <div class="px-4 py-4 border-t border-gray-200 mt-auto h-16">
      <div class="flex items-center h-full">
        ...
        <div
          class="ml-3 flex-1 transition-opacity duration-300"
          :class="[
