              ...
              <div class="flex items-start justify-between">
                <div class="flex items-start space-x-3 flex-1 min-w-0">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div v-if="inbox.phone_number" class="mt-2 flex items-center space-x-4 text-xs text-gray-400">
    ...
    >
      <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
                ...
                <div class="w-64 h-64 bg-gray-50 flex items-center justify-center">
                  ...
                  <div v-else-if="qrCodeError" class="flex flex-col items-center text-center px-4">
                    ...
                    <button
                      ...
                      class="mt-3 px-3 py-1 text-xs bg-red-600 text-white rounded hover:bg-red-700"
                    >
                      Tentar novamente
                    </button>
                  </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 rounded-b-lg">
          <button
            @click="closeQRModal"
            class="w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
          >
            Fechar
          </button>
        </div>
