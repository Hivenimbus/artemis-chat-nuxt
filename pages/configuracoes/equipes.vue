                    ...
                    <div v-if="getTeamAgents(team.id).length > 0" class="mt-2 flex items-center space-x-2">
                      <div class="flex -space-x-2">
                        <div
                          ...
                          :key="agent.id"
                          class="w-6 h-6 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-xs font-medium text-white border-2 border-white shadow-sm"
                          :title="agent.name"
                        >
        ...
        <div class="px-6 py-5 space-y-4">
          ...
          <div class="space-y-2">
            ...
            <input
              ...
              class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200"
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              <input
                ...
                class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200"
              />
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
          ...
          <div class="flex-1 overflow-hidden flex flex-col space-y-2">
            ...
            <div class="flex-1 overflow-y-auto border border-gray-200 rounded-lg space-y-1 p-2 custom-scrollbar-container bg-gray-50/50">
              <div
                ...
                :key="agent.id"
                class="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-200 hover:border-indigo-300 hover:shadow-sm transition-all duration-200 cursor-pointer"
